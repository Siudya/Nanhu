...
class NewMiscExu (id:Int, complexName:String, val bypassInNum:Int)(implicit p:Parameters) extends BasicExu{
  ...
  override lazy val module = new NewMiscExuImpl(this, cfg)
}
...
class NewMiscExuImpl(outer:NewMiscExu, exuCfg:ExuConfig)(implicit p:Parameters) extends BasicExuImpl(outer) with HasCSRConst{
