...
object XDecode extends DecodeConstants {
  val table: Array[(BitPat, List[BitPat])] = Array(
    ...
    BEQ     -> List(SrcType.reg, SrcType.reg, SrcType.DC, FuType.bru, ALUOpType.beq,    N, N, N, N, N, N, N, N, VstartType.hold, SelImm.IMM_SB),
    BNE     -> List(SrcType.reg, SrcType.reg, SrcType.DC, FuType.bru, ALUOpType.bne,    N, N, N, N, N, N, N, N, VstartType.hold, SelImm.IMM_SB),
    BGE     -> List(SrcType.reg, SrcType.reg, SrcType.DC, FuType.bru, ALUOpType.bge,    N, N, N, N, N, N, N, N, VstartType.hold, SelImm.IMM_SB),
    BGEU    -> List(SrcType.reg, SrcType.reg, SrcType.DC, FuType.bru, ALUOpType.bgeu,   N, N, N, N, N, N, N, N, VstartType.hold, SelImm.IMM_SB),
    BLT     -> List(SrcType.reg, SrcType.reg, SrcType.DC, FuType.bru, ALUOpType.blt,    N, N, N, N, N, N, N, N, VstartType.hold, SelImm.IMM_SB),
    BLTU    -> List(SrcType.reg, SrcType.reg, SrcType.DC, FuType.bru, ALUOpType.bltu,   N, N, N, N, N, N, N, N, VstartType.hold, SelImm.IMM_SB),
